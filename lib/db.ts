...
const development_addr = `mongodb+srv://${process.env.MONGODB_ID}:${process.env.MONGODB_PASSWORD}@cluster0.ripbkdf.mongodb.net/${process.env.MONGODB_DBNAME}?retryWrites=true&w=majority`;
